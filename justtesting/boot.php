        ...
        <div class="container">
            <form role="form" action="boot.php" method="post">
                ...
                <input type="text" class="form-control text-center" id="name" name="sender" value="File" readonly="readonly">
                  <div class="settings-grid compact-settings compact-form" id="2step3">
...
/* More compact styling for settings boxes */
.compact-form .setting-box {
    min-height: 180px;
    padding: 12px;
    margin-bottom: 10px;
}

.compact-form .setting-box h3 {
    font-size: 0.95rem;
    margin-bottom: 6px;
}

.compact-form .fa-icon {
    font-size: 1.3rem;
    padding: 8px;
    margin-bottom: 5px;
}
...
@media (max-width: 768px) {
    .compact-settings.settings-grid {
        grid-template-columns: repeat(2, 1fr);
        gap: 8px;
    }
